...
import {Table, TableContainer, TableHead, TableBody, TableRow, TableCell, IconButton} from "@mui/material";
  ...
  return (
    <>
     <div>
      ...
      <div>
        <Typography variant="h4" sx={{mb: 1}}>Credit Report</Typography>
        <Input variant="filled" type="file"  onChange={handleFileChange} /><br />
      </div>
      <>
      {creditReport ? (
        <div>
                 ...
                 <TableRow>
                  ...
                  <TableCell>
                    <Stack direction='column' alignItems={'start'}>
                      <IconButton>
                       <DangerousIcon sx={{color: 'red'}} fontSize="large" />
                      </IconButton>
        ...
        <LetterSelect value={selectedLetter} setSelectedLetter={setSelectedLetter} /> 
        {selectedLetter && (<RichTextEditor data={selectedLetter.letter} />)}
        ...
        >
          <Fade in={open}>
            <Box sx={style}>
              ...
              <div style={{ display: "flex", marginTop: "20px" }}>
                <div style={{ flex: 1 }}>
                  <h4>
                    ...
                    <FormGroup>
                      <FormControlLabel 
                       control={<Checkbox checked={equifax} onChange={(e) => setEquifax(!equifax)} />} 
                       label="Equifax" 
                       />
                      <FormControlLabel
                        control={<Checkbox checked={experian} onChange={() => setExperian(!experian)} />}
                        label="Experian"
                      />
                      <FormControlLabel
                        control={<Checkbox checked={transUnion} onChange={() => setTransUnion(!transUnion)} />}
                        label="TransUnion"
                      />
                    </FormGroup>
                  </h4>
              ...
              <Button variant="contained" onClick={handleSelectDisputeItem}>Next</Button>
            </Box>
          </Fade>
        </Modal>
      </div>
